  ...
  return (
    ...
    <div className="flex items-center ml-auto">
      <h1>Settings</h1>
        ...
        <div className="bg-yellow-700 rounded-t-3xl px-2 py-2">
          <div className="flex justify-around items-center">
            <div className="flex flex-col items-center gap-1">
              <Home size={22} className="text-black-500" />
              <span className="text-xs text-black-500 font-medium">Dashboard</span>
            </div>
            <div className="flex flex-col items-center gap-1">
              <ShoppingCart size={22} className="text-gray-400" />
              <span className="text-xs text-gray-400">Market Place</span>
            </div>
            <div className="flex flex-col items-center gap-1">
